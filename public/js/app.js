...
// ---------------------------------------------------------------------------
import { isConfigured, SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=35';
import { toast, esc } from './ui.js?v=35';
...
const db = await import('./db.js?v=35');
const agentViews = await import('./views-agent.js?v=35');
const adminViews = await import('./views-admin.js?v=35');
const scoringViews = await import('./views-scoring.js?v=35');
const rubricViews = await import('./views-rubric.js?v=35');
const accountViews = await import('./views-account.js?v=35');
